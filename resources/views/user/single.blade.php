                    ...
                    <div class="col-lg-9 col-md-12 col-sm-12 col-xs-12">
                        <div class="page-wrapper">
                            ...
                            <div class="blog-content">  
                                ...
                                <img src="{{asset('layout_user/upload/tech_menu_09.jpg')}}" alt="" class="img-fluid img-fullwidth">
                                ...
                                <div class="col-lg-12">
                                    <div class="banner-spot clearfix">
                                        <div class="banner-img">
                                            <img src="{{asset('layout_user/upload/banner_01.jpg')}}" alt="" class="img-fluid">
                                        </div><!-- end banner-img -->
                                    </div><!-- end banner -->
                                </div><!-- end col -->
                            </div><!-- end row -->
                                            ...
                                            <div class="list-group">
                                                <a href="tech-single.html" class="list-group-item list-group-item-action flex-column align-items-start">
                                                    <div class="w-100 justify-content-between text-right">
                                                        <img src="{{asset('layout_user/upload/tech_menu_19.jpg')}}" alt="" class="img-fluid float-right">
                                            ...
                                            <div class="list-group">
                                                <a href="tech-single.html" class="list-group-item list-group-item-action flex-column align-items-start">
                                                    <div class="w-100 justify-content-between">
                                                        <img src="{{asset('layout_user/upload/tech_menu_20.jpg')}}" alt="" class="img-fluid float-left">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="comments-list">
                                            ...
                                            <div class="media">
                                                <a class="media-left" href="#">
                                                    <img src="{{asset('layout_user/upload/author_01.jpg')}}" alt="" class="rounded-circle">
                                                </a>
                                                <div class="media-body">
                                            ...
                                            <div class="media last-child">
                                                <a class="media-left" href="#">
                                                    <img src="{{asset('layout_user/upload/author_02.jpg')}}" alt="" class="rounded-circle">
                                                </a>
                                                <div class="media-body">
                            ...
                            <div class="widget">
                                ...
                                <div class="trend-videos">
                                    <div class="blog-box">
                                        <div class="post-media">
                                            <a href="tech-single.html" title="">
                                                <img src="{{asset('layout_user/upload/video_01.jpg')}}" alt="" class="img-fluid">
                                                <div class="hovereffect">
                                    ...
                                    <div class="blog-box">
                                        <div class="post-media">
                                            <a href="tech-single.html" title="">
                                                <img src="{{asset('layout_user/upload/video_02.jpg')}}" alt="" class="img-fluid">
                                                <div class="hovereffect">
                                                    <span class="videohover"></span>
                                                </div><!-- end hover -->
                                            </a>
                                    ...
                                    <div class="blog-box">
                                        <div class="post-media">
                                            <a href="tech-single.html" title="">
                                                <img src="{{asset('layout_user/upload/video_03.jpg')}}" alt="" class="img-fluid">
                                                <div class="hovereffect">
                                                    <span class="videohover"></span>
                                                </div><!-- end hover -->
                                            </a>
